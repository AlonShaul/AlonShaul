  ...
  return (
    ...
    >
      ...
      {isMobile && (
        ...
        >
          <img src={isiOS ? (simulatedFullscreen ? minimizeScreenIcon : fullScreenIcon) 
                      : (document.fullscreenElement ? minimizeScreenIcon : fullScreenIcon)}
               alt="Fullscreen Toggle" className="w-8 h-8" />
        </button>
      )}
    </div>
  );
